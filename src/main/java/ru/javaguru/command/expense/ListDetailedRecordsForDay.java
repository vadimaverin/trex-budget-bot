...
public class ListDetailedRecordsForDay implements Command {
    ...
    public BotCommand command() {
        return BotCommand.DETALIEDRECORDSFORDAY;
    }

    @Override
    public void execute(CommonInfo commonInfo) {

        List<ExpenseDto> expensesForDay = expenseService.findDay();
