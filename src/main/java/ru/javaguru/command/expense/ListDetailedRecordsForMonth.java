...
public class ListDetailedRecordsForMonth implements Command {
    ...
    public BotCommand command() {
        return BotCommand.DETALIEDRECORDSFORMONTH;
    }

    @Override
    public void execute(CommonInfo commonInfo) {

        List<ExpenseDto> expensesForDay = expenseService.findMonth();
